...
const Reviews = ({ navigation, route }) => {
  ...
  // Use the actual reviews array length for accurate percentage calculation
        ...
        <View>
          ...
          <View>
            {Object.keys(reviewGroups)
              .sort((a, b) => b - a)
              .map((i, index) => {
                // Calculate percentage based on actual reviews array length for accuracy
                const filled = totalReviews > 0 ? (reviewGroups[i] / totalReviews) * 100 : 0
